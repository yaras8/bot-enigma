...
const token = "7736987823:AAHtUGyF3mS8LOLEesDNkA3H1X8i3hBCens";
...
const secuencias = {
    ...
    VIENTO: "VIENTO",
    MADRE: "MI MADRE",
    FRASE_CLAVE: "LPDUPEECRPALPAUMSFDLCYLISURSYEQESDPAVQSAASLHDM",
...
function enviarSiguienteMensaje(chatId) {
    ...
    switch (jugador.estado) {
        ...
        case 16:
            ...
            break;
        case 17:
            bot.sendMessage(chatId, "¿Veis lo bien que se lo están pasando los padres? Es hora de molestarles un poco.\n \nId con ellos y preguntad a todos: “¿Cuál es el color del misterio?”\n \nUno de ellos deberá contestaros: “Negro como una noche sin luna”\n \nEsa persona tiene vuestra respuesta.\n¿A qué estáis esperando?");
            jugador.estado = 18;
            break;
        case 18:
...
// Registro del mensaje en la consola
console.log(`Mensaje recibido de ${msg.from.username || 'un usuario'}: ${msg.text}`);
